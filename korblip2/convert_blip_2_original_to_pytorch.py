...
def create_rename_keys(config, model_name):
    ...
    if "itm" in model_name or "pretrain" in model_name:
...
def get_blip2_config(model_name, eos_token_id):
    ...
    elif "itm" in model_name or "pretrain" in model_name:
        text_config = {}
    else:
...
def convert_blip2_checkpoint(
    ...
    model_name_to_original = {
        ...
        "blip2-pretrain": ("blip2", "pretrain"),
        "blip2-pretrain-coco": ("blip2", "coco"),
    }
